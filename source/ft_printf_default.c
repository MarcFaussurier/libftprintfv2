...
static void		ft_phase_a()
{
	...
	ft_printf_id_add(&ft_vsnprintf_shrt, "hd", "hi",							_);
	...
	ft_printf_id_add(&ft_vsnprintf_ulong, "lu",								_);
	ft_printf_id_add(&ft_vsnprintf_ullong, "Lu", "llu", "zu",					_);
	ft_printf_id_add(&ft_vsnprintf_osshrt, "hho",								_);
	ft_printf_id_add(&ft_vsnprintf_oshrt, "ho", 			_);
	ft_printf_id_add(&ft_vsnprintf_oint, "o", 			_);
	ft_printf_id_add(&ft_vsnprintf_olong, "lo", 			_);
	ft_printf_id_add(&ft_vsnprintf_ollong, "Lo", "llo", "zo",
...
static void ft_phase_b()
{
	...
	ft_printf_id_add(&ft_vsnprintf_xsshrt, "hhx", 			_);
	ft_printf_id_add(&ft_vsnprintf_xshrt, "hx", 			_);
	ft_printf_id_add(&ft_vsnprintf_xint, "x",	 		_);
	ft_printf_id_add(&ft_vsnprintf_xlong, "lx", 			_);
	ft_printf_id_add(&ft_vsnprintf_xllong, "Lx", "llx", "zx", 	_);
	ft_printf_id_add(&ft_vsnprintf_xsshrt_up, "hhX",		_);
...
{
	ft_printf_id_add(&ft_vsnprintf_char, "hhc", "hc", "c", "lc", "llc", "zc", "Lc",
			"hhC", "hC", "C", "lC", "llC", "zC", "LC", _);
	ft_printf_id_add(&ft_vsnprintf_str, "hhs", "hs", "s", "ls", "lls", "zs", "Ls",
			"hhS", "hS", "S", "lS", "llS", "zS", "LS", _);
	ft_printf_id_add(&ft_vsnprintf_ptr, "hhp", "hp", "p", "lp", "llp", "zp", "Lp",
			_);
