...
typedef			int (t_printf_fnd)(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
...
/**/
int 			ft_vsnprintf_flt(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_dbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_ldbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
/**/
int 			ft_vsnprintf_eflt(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_edbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_eldbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
/**/
int 			ft_vsnprintf_eflt_up(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_edbl_up(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_eldbl_up(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
/**/
int 			ft_vsnprintf_aflt(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_adbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_aldbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
/**/
...
/**/
int 			ft_vsnprintf_gflt(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_gdbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_gldbl(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
/**/
int 			ft_vsnprintf_gflt_up(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_gdbl_up(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
int 			ft_vsnprintf_gldbl_up(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
/**/
...
int 			ft_vsnprintf_cnt(t_printf_ctx *ctx, char **str, size_t *size, va_list ap);
